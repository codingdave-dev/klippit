...
const ChooseServiceAndPriceForm_Edit = ({
  editCampaignStep1,
  nextForm,
  handleSubmit,
  error,
  ...
  const handleTypeOfBusiness = async (value) => {
    ...
    if (
      ...
      let ref = await editCampaignStep1(id, value);
        ...
        >
          ...
          >
            <Grid item container alignItems={"center"}>
              ...
              <Grid item>
                <Tooltip
                  title={"What category would you place your business in?"}
                  placement={"right"}
                ...
                >
                  <img
                    ...
                    alt="question mark"
                    style={{ width: "18px", marginLeft: "0.8em" }}
                  />
                </Tooltip>
              </Grid>
            </Grid>
            ...
            <Grid item>
              <Grid item container alignItems={"center"}>
                ...
                <Grid item>
                  <Tooltip
                    title={
                      "Is the product that you are selling restricted to a certain size or color? If so enter it here. Skip this if it is not applicable to you"
                    }
                    placement={"right"}
                    classes={{ tooltip: classes.tooltip }}
                  >
                ...
                <Grid item container direction={"column"}>
                  ...
                  <Grid item>
                    ...
                    >
                      ...
                      <Tooltip
                        title={"Ex: 60-Minute Swedish or Deep Tissue Massage"}
                        placement={"right"}
                        classes={{ tooltip: classes.tooltip }}
                      >
                        <img
                ...
                <Grid item container direction={"column"}>
                  <Grid item>
                    ...
                    >
                      ...
                      <Tooltip
                        title={
                          "Your deal is tied to a one time incentive that influencers will have to complete to redeem this deal. Ex: You must take a picture of yourself with the (product)"
                        }
                        placement={"right"}
                        classes={{ tooltip: classes.tooltip }}
                      >
                        <img
                          src="/assets/icon/campaign/question.png"
                          alt="question mark"
                          style={{ width: "18px", marginLeft: "0.7em" }}
                        />
                      </Tooltip>
                    </Typography>
                  </Grid>
                ...
                <Grid item container direction={"column"}>
                  <Grid item>
                    ...
                    >
                      ...
                      <Tooltip
                        title={"How much would this cost without a discount?"}
                        placement={"right"}
                        classes={{ tooltip: classes.tooltip }}
                      >
                        <img
                ...
                <Grid item container direction={"column"}>
                  <Grid item>
                    ...
                    >
                      ...
                      <Tooltip
                        title={
                          "Influencers will be sharing the content they create on their social media pages. What hashtag do you want them to use when they post about your business?"
                        }
                        placement={"right"}
                        classes={{ tooltip: classes.tooltip }}
                      >
                ...
                <Grid item container direction={"column"}>
                  <Grid item>
                    ...
                    >
                      ...
                      <Tooltip
                        title={
                          "How much will you be discounting this product/service for influencers?"
                        }
                        placement={"right"}
                        classes={{ tooltip: classes.tooltip }}
                      >
...
export default withRouter(
  connect(
    ...
    reduxForm({ form: "addBusinessType", enableReinitialize: true, validate })(
      ChooseServiceAndPriceForm_Edit
    )
  )
);
