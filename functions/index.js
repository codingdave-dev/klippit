                 ...
                 <tr style="border-collapse:collapse"> 
                  <td valign="top" align="center" style="padding:0;Margin:0;width:600px"> 
                   <table width="100%" cellspacing="0" cellpadding="0" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px"> 
                     ...
                     <tr style="border-collapse:collapse"> 
                      <td align="left" class="es-m-txt-l" style="Margin:0;padding-top:10px;padding-bottom:10px;padding-left:15px;padding-right:40px"><span class="es-button-border" style="border-style:solid;border-color:#474745;background:#54C5D0;border-width:0px;display:inline-block;border-radius:22px;width:auto"><a href="https://join.klippitapp.com/preview/eab6a405a5e10d9099f67acfa28530c8/prelaunchupdated/" class="es-button" target="_blank" style="mso-style-priority:100 !important;text-decoration:none;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:helvetica, 'helvetica neue', arial, verdana, sans-serif;font-size:14px;color:#FFFFFF;border-style:solid;border-color:#54C5D0;border-width:20px 35px;display:inline-block;background:#54C5D0;border-radius:22px;font-weight:normal;font-style:normal;line-height:17px;width:auto;text-align:center">How it works</a></span></td> 
                     </tr> 
                     <tr style="border-collapse:collapse"> 
